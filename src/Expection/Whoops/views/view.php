...
<body>
    <div class="">
        <div class="container">
            ...
            <div>
              <h5>Need help?</h5>
              <p>If you still unable to solve this issue you can feel free to ask in our community
                <a href="https://zestframework.xyz/faq/view/uRvmJGC/How+to+ask+question+or+create+topic">How to ask?</a>
              </p>
            </div>
        </div>
    </div>
