...
if (!function_exists('printl')) {
    ...
    {
        return (new \alphaz\Language\Language())->print($key, $default);
    }
}
...
if (!function_exists('input')) {
    function input($key)
    {
        return alphaz\Input\Input::input($key);
    }
}
...
if (!function_exists('escape')) {
    ...
    {
        return alphaz\Input\Input::clean($str, $type);
    }
}
...
if (!function_exists('restore_line_break')) {
    ...
    {
        return \alphaz\Input\Input::restoreLineBreaks($input);
    }
}
...
if (!function_exists('is_submit')) {
    ...
    {
        return alphaz\Input\InPut::isFromSubmit($name);
    }
}
...
if (!function_exists('site_base_url')) {
    ...
    {
        return alphaz\Site\Site::siteBaseUrl();
    }
}
...
if (!function_exists('current_url')) {
    ...
    {
        return alphaz\Site\Site::siteUrl();
    }
}
...
if (!function_exists('redirect')) {
    ...
    {
        return alphaz\Site\Site::redirect($url);
    }
}
...
if (!function_exists('salts')) {
    ...
    {
        return alphaz\Site\Site::salts($len, $special);
    }
}
...
if (!function_exists('set_cookie')) {
    ...
    {
        $cookie = new alphaz\Cookies\Cookies();
...
if (!function_exists('add_system_message')) {
    function add_system_message($msg, $type = null)
    {
        ...
        return (new alphaz\SystemMessage\SystemMessage())->add(['msg'=>$msg, 'type'=>$type]);
    }
}
...
if (!function_exists('view_system_message')) {
    ...
    {
        return (new alphaz\SystemMessage\SystemMessage())->view();
    }
}
...
if (!function_exists('route')) {
    ...
    {
        return (new \alphaz\Common\Root())->get($key, $default);
    }
}
...
if (!function_exists('encrypt')) {
    ...
    {
        return (new \alphaz\Encryption\Encryption())->encrypt($data);
    }
}
...
if (!function_exists('decrypt')) {
    ...
    {
        return (new \alphaz\Encryption\Encryption())->decrypt($token);
    }
}
...
if (!function_exists('view')) {
    ...
    {
        return (new alphaz\View\View())::view($file, $args, $minify, $headers, $code);
    }
}
...
if (!function_exists('model')) {
    ...
    {
        return (object) (new \alphaz\Common\Model\Model())->set($model)->execute();
    }
}
...
if (!function_exists('write_file')) {
    ...
    {
        return (new \alphaz\Files\FileHandling())->open($file, $mode)->write($value);
    }
}
...
if (!function_exists('read_file')) {
    ...
    {
        return (new \alphaz\Files\FileHandling())->open($file, $mode)->read();
    }
}
...
if (!function_exists('pagination')) {
    ...
    {
        return (new \alphaz\Common\Pagination($total, $perPage, $current, $urlAppend, $ulCLass, $liClass, $aClass))->pagination();
    }
}
...
if (!function_exists('container')) {
    ...
    {
        return (new \alphaz\Common\Container\DIS())->get($identifier, $params);
    }
}
...
if (!function_exists('config')) {
    ...
    {
        return (new \alphaz\Common\Configuration())->get($key, $default);
    }
}
function __get_env($key, $default = null)
{
    return (new \alphaz\Common\Env())->get($key, $default);
}
...
if (!function_exists('log_message')) {
    ...
    {
        return (new \alphaz\Common\Logger\Logger())->setCustomFile($file)->$type($message);
    }
}
...
if (!function_exists('decode_html_entity')) {
    ...
    {
        return (new \alphaz\Input\Input())->decodeHtmlEntity($content);
    }
}
...
{
    return new \alphaz\Common\Maintenance();
}
